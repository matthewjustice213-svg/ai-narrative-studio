    ...
    scenes: [
      {
        ...
        animationAction: "Fries freezes, then overcorrects with fake confidence.",
        animationTiming: "Hold two beats on the printer before Fries reacts.",
        animationAudio: "Printer shriek leads the motion cue.",
