...
export const sceneSchema = z.object({
  ...
  animationStatus: z.enum(["rough", "blocked", "animating", "review", "locked"]).default("rough"),
  animationAction: z.string().default(""),
  animationTiming: z.string().default(""),
  animationAudio: z.string().default(""),
